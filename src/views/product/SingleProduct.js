    ...
    <div>
      <MDBCard shadow='0' border='primary' background='white' className='mb-3'>
        ...
        <MDBCardBody className='text-primary'>
                ...
                <MDBRow>
                <MDBCol sm="3">
                <Button variant="outlined" style={{width:'100px',height:'35px'}} ><Link to={`/mproduct/update-product/${product._id}`}> <IconButton><BorderColorIcon color="primary"/> </IconButton> Edit</Link> </Button> </MDBCol>
                <MDBCol sm="9">
                <Button variant="outlined" sx={{color:'red'}}  startIcon={<DeleteIcon onClick={()=>{handleDelete(product._id)}} sx={{color:'red'}} />}>
        Delete
      </Button>
